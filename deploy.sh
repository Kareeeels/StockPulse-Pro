...
echo -e "${YELLOW}7. Iniciando Backend en puerto 10000 (screen: stockpulse-backend)...${NC}"
screen -dmS stockpulse-backend bash -c "cd /opt/StockPulse-Pro/backend && java -jar target/stockpulse-pro-1.0.0.jar"

echo -e "${YELLOW}8. Iniciando Frontend en puerto 10001 (screen: stockpulse-frontend)...${NC}"
screen -dmS stockpulse-frontend bash -c "cd /opt/StockPulse-Pro/frontend && python3 -m http.server 10001"
...
echo "=========================================${NC}"
echo ""
echo "  📱 Frontend: http://194.163.180.138:10001/login.html"
echo "  🖥️  Backend API: http://194.163.180.138:10000/api"
echo ""
