...
- OS: Ubuntu 24.04
- Backend port: 8081
- Frontend port: 3001 (o el que prefieras)
...
# Ejecutar el frontend en el puerto 3001
...
- **Frontend**: http://194.163.180.138:3001/login.html
- **Backend API**: http://194.163.180.138:8081/api
